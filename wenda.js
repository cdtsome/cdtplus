...
//允许复制
check_run('wenda增加开启复制按钮', function() {
...
//增强搜索 
check_run('wenda增强自带搜索', function() {
...
//屏蔽水贴
check_run('wenda自动屏蔽水贴和远古贴', function() {
...
//屏蔽水回答
check_run('wenda自动屏蔽水回答', function() {
	if (location.href.search(/wenda.codingtang.com\/questions\/.+\//) != -1) {
		var water_types = [
...
//不看无敌水贴
check_run('wenda显示不看无敌水贴按钮', function() {
...
//自动填写验证码
check_run('wenda自动识别验证码', function() {
	function add_event() {
